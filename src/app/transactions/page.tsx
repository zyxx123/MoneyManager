    ...
    <div className="flex flex-col min-h-screen max-w-md mx-auto bg-background text-text-main pb-24">
      <header className="sticky top-0 z-10 flex flex-col p-4 bg-surface/90 backdrop-blur-md border-b-[3px] border-black space-y-4">
        <div className="flex items-center">
          <Link href="/" className="p-2 -ml-2 text-text-secondary hover:bg-gray-100 dark:hover:bg-gray-800 rounded-none transition-colors active:translate-y-1.5 active:translate-x-1.5 active:shadow-none">
            <ArrowLeft size={24} />
          </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="flex-1 p-2 bg-border-subtle/30 border-[3px] border-black rounded-none focus:ring-2 focus:ring-primary focus:border-transparent outline-none text-[15px] font-medium transition-all duration-200"
          />
        </div>
      </header>
