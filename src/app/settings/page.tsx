  ...
  return (
    <div className="flex flex-col min-h-screen max-w-md mx-auto bg-background text-text-main pb-24">
      <header className="sticky top-0 z-10 flex items-center p-4 bg-background/90 backdrop-blur-md">
        ...
        <h1 className="text-[20px] font-bold ml-2">Pengaturan Aplikasi</h1>
      </header>
        ...
        <div className="bg-surface border-[3px] border-black rounded-2xl overflow-hidden shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          ...
          <div className="p-5 border-b-[3px] border-black flex items-center justify-between">
            <div className="flex items-center gap-4 text-text-main">
              ...
              <span className="font-bold text-[16px]">Pencadangan Data</span>
            </div>
            <span className="text-[13px] text-primary font-bold">Segera Hadir</span>
          </div>
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="font-bold text-[16px]">Hapus Semua Data</span>
