...
export default function Home() {
  ...
  return (
    <div className="p-4 max-w-md mx-auto space-y-6 pt-6 pb-20">
      {/* Total Balance Card */}
      <div className="bg-primary rounded-[24px] p-6 text-white shadow-[0_8px_30px_rgba(47,111,78,0.15)] relative overflow-hidden">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-surface border border-border-subtle rounded-[16px] p-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
